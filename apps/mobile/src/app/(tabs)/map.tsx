...
import { apiRequest, formatCompactMoney, formatDate, parseJsonData, PlaceSuggestion, PlaceSuggestionResponse } from '@/lib/api';
            ...
            <View style={styles.placeContent}>
              <View style={styles.placeCopy}>
                ...
                <View style={styles.placeFooter}>
                  ...
                  {selected.estimatedCostVnd ? <Text style={styles.cost}>{formatCompactMoney(selected.estimatedCostVnd)}</Text> : <Text style={styles.cost}>Khám phá</Text>}
                </View>
              </View>
